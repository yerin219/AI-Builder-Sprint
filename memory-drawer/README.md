...
- 흰색 카드 안에서 각 문서의 원래 형태와 내용을 살립니다.
- 사용자가 확인한 정보만 표시합니다.
...
| 구분 | 앞면 | 뒷면 | AI 회상 질문 |
| --- | --- | --- | --- |
| 영수증 | 흰색 카드, 원본 형태, 날짜, 가게명 | 동행인·날씨·기분, 사진 또는 자유 기록 | 사용하지 않음 |
| 티켓 | 흰색 카드, 원본 형태, 날짜, 행사명, 장소, 입력된 경우에만 좌석 | 동행인·날씨·기분, 직접 기록 또는 질문 답변과 제목 | 사용자 선택 |
...
- 세 기록 모두 흰색 카드로 통일하면서도 원본 종이의 형태와 내용을 살려 아날로그 기록의 감성을 디지털에서도 유지합니다.
