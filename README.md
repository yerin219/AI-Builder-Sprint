...
AI Builder Sprint 2026 예선 제출용 저장소입니다. 이 프로젝트는 별도 배포 주소 없이 로컬 기동 방식으로 제출합니다. 심사 시에는 아래 안내에 따라 프론트엔드와 백엔드를 실행해 주세요.
...
종이 영수증, 티켓, 손편지는 시간이 지나면 훼손되거나 잃어버리기 쉽고, 날짜와 가격만 저장하면 그날의 사람과 감정은 남기기 어렵습니다. 기억서랍은 종이 문서를 AI로 인식하되 세부 내용은 사용자 직접 입력을 통해 단순히 문서를 저장하는 서비스가 아니라 기억과 감정을 다시 꺼내 볼 수 있도록 돕는 웹을 설계했습니다.
...
5. 사용자 확정값만 추억 카드로 저장하고 실제 추억 날짜의 연도별 서랍에서 다시 볼 수 있습니다.
